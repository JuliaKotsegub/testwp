...
<?php get_header();?>
  ...
  <div class="wrapper">
    <main class="main">
      ...
      <section class="bg">
        <img src="<?php bloginfo('template_url'); ?>/assets/images/bg-img.png" alt="" class="bg__image">
      </section>
        ...
        <div class="container inner">
          <div class="service__tabs">
            ...
            <div class="tabs">
              <div class="tab" onclick="showTab(1)">
                <img class="icon-tab" id="tabIcon1" src="<?php bloginfo('template_url'); ?>/assets/images/Home/icon1.png" alt="Значок 1"> Приватному Сектору
              </div>
              <div class="tab" onclick="showTab(2)">
                <img class="icon-tab" id="tabIcon2" src="<?php bloginfo('template_url'); ?>/assets/images/Home/icon2.png" alt="Значок 2"> Бізнесу
              </div>
            </div>
          </div>
          <div class="tab-content">
            <div class="tab-pane" id="tab1">
              <div class="block">
                <img src="<?php bloginfo('template_url'); ?>/assets/images/Home/house-chimney 1.png" alt="" class="service__block-img">
              ...
              <div class="block">
                <img src="<?php bloginfo('template_url'); ?>/assets/images/Home/house-chimney 2.png" alt="" class="service__block-img">
              ...
              <div class="block">
                <img src="<?php bloginfo('template_url'); ?>/assets/images/Home/house-chimney3.png" alt="" class="service__block-img">
              ...
              <div class="block">
                <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/house-chimney 4.png" alt="" class="service__block-img">
              ...
              <div class="block">
                <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/house-chimney 5.png" alt="" class="service__block-img">
                <h5 class="service__block-title">Додаткові послуги</h5>
                <div class="service__block-text">Хімчистка меблів та килимів;
                  чистка люстр та світильників; миття холодильника та печі</div>
              </div>
              <div class="block">
                <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/house-chimney 6.png" alt="" class="service__block-img">
                <h5 class="service__block-title">Додаткові послуги</h5>
                <div class="service__block-text">Хімчистка меблів та килимів;
                  чистка люстр та світильників; миття холодильника та печі</div>
              </div>
              <div class="block">
                <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/house-chimney 7.png" alt="" class="service__block-img">
                <h5 class="service__block-title">Додаткові послуги</h5>
                <div class="service__block-text"> Хімчистка меблів та килимів;
                  чистка люстр та світильників; миття холодильника та печі</div>
              </div>
              <div class="block">
                <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/house-chimney 8.png" alt="" class="service__block-img">
                <h5 class="service__block-title">Додаткові послуги</h5>
                <div class="service__block-text">Хімчистка меблів та килимів;
                  чистка люстр та світильників; миття холодильника та печі</div>
              </div>
        ...
        <div class="container inner">
          <div class="process__inner">
            <div class="process__left">
              <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/process1.png" alt="">
            </div>
        ...
        <div class="collage__inner">
          <div class="collage__grid">
            <div class="collage__grid-item collage__one">
              <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/collage1.png" alt="Cleaning">
            </div>
            <div class="collage__grid-item collage__two-top">
              <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/collage2.png" alt="Cleaning">
            </div>
            <div class="collage__grid-item collage__three">
              <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/collage4.png" alt="Cleaning">
            </div>
            <div class="collage__grid-item collage__four">
              <img class="collage__four-top" src=" <?php bloginfo('template_url'); ?>/assets/images/Home/collage5.png" alt="Cleaning">
              <img class="collage__four-bottom" src=" <?php bloginfo('template_url'); ?>/assets/images/Home/collage6.png" alt="Cleaning">
            </div>
            <div class="collage__grid-item collage__two-bottom">
              <img src=" <?php bloginfo('template_url'); ?>/assets/images/Home/collage3.png" alt="Cleaning">
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container inner">
          <div class="blog-box__top">
            ...
            <a href="#" class="blog-box__top-link">
              ...
              <img class="blog-box__top-img" src=" <?php bloginfo('template_url'); ?>/assets/images/Home/arrow_back.png" alt="arrow_back">
            </a>
          </div>
          <div class="blog-box__items">
            <div class="blog-box__item">
              <a class="blog-box__img-link" href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/blog/1.jpg" alt=""></a>
              ...
              <a href="#" class="blog-box__blocks">
                ...
                <img src="<?php bloginfo('template_url'); ?>/assets/images/Home/arrow_back.png" alt="" class="blog-box__blocks-arrow">
              </a>
            </div>
            <div class="blog-box__item">
              <a class="blog-box__img-link" href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/blog/1.jpg" alt=""></a>
            ...
            <div class="carousel__container">
              <div class="carousel__slide active slide1">
                <div class="carousel__slide-flex">
                  <img class="carousel__slide-img" src="<?php bloginfo('template_url'); ?>/assets/images/home/partners1.png" alt="" class="carousel__slide-img">
                  <img class="carousel__slide-img" src="<?php bloginfo('template_url'); ?>/assets/images/home/partners2.png" alt="" class="carousel__slide-img">
                  <img class="carousel__slide-img" src="<?php bloginfo('template_url'); ?>/assets/images/home/partners3.png" alt="" class="carousel__slide-img">
                  <img class="carousel__slide-img" src="<?php bloginfo('template_url'); ?>/assets/images/home/partners4.png" alt="" class="carousel__slide-img">
                  <img class="carousel__slide-img" src="<?php bloginfo('template_url'); ?>/assets/images/home/partners5.png" alt="" class="carousel__slide-img">
                  <img class="carousel__slide-img" src="<?php bloginfo('template_url'); ?>/assets/images/home/partners6.png" alt="" class="carousel__slide-img">
                  <img class="carousel__slide-img" src="<?php bloginfo('template_url'); ?>/assets/images/home/partners7.png" alt="" class="carousel__slide-img">
                </div>
              </div>
              <div class="carousel__slide active slide1">
                <div class="carousel__slide-flex">
              ...
              <div class="carousel-slide active slide1">
                <div class="reviews-slide">
                  <div class="reviews-slide-stars">
                    <img class="reviews-slide-star" src="<?php bloginfo('template_url'); ?>/assets/images/Home/Star 1.png" alt="">
                    <img class="reviews-slide-star" src="<?php bloginfo('template_url'); ?>/assets/images/Home/Star 1.png" alt="">
                    <img class="reviews-slide-star" src="<?php bloginfo('template_url'); ?>/assets/images/Home/Star 1.png" alt="">
                    <img class="reviews-slide-star" src="<?php bloginfo('template_url'); ?>/assets/images/Home/Star 1.png" alt="">
                    <img class="reviews-slide-star" src="<?php bloginfo('template_url'); ?>/assets/images/Home/Star 1.png" alt="">
                  ...
                  <div class="reviews-slide-author">
                    <img src="<?php bloginfo('template_url'); ?>/assets/images/Home/avatar.png" alt="" class="reviews-slide-img">
          ...
          <div class="question__items">
            <details class="question__deploy" onclick="this.classList.toggle('active')">
              <summary class="question__deploy-name">
                ...
                <img src="<?php bloginfo('template_url'); ?>/assets/images/Home/arrow_tab.png" alt="" class="deploy__arrow">
              </summary>
